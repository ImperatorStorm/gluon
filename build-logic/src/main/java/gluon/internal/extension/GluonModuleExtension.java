...
/**
 * The definition of a Gluon module within its buildscript.
 */
public interface GluonModuleExtension {
	/**
	 ...
	 * See the "Gradle Conventions" section of CONTRIBUTING.MD for more information
	 */
	void entrypoints(Action<NamedDomainObjectContainer<GluonModuleExtensionImpl.NamedWriteOnlyList>> action);

	void injectedInterface(String minecraftClass, Action<GluonModuleExtensionImpl.NamedWriteOnlyList> action);
