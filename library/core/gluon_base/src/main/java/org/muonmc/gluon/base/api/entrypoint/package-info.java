 ...
 * <ul>
 *     <li>{@linkplain org.muonmc.gluon.base.api.entrypoint.ModInitializer ModInitializer},
 *     a general-purpose mod initializer, ran before registries are frozen.</li>
 *     <li>{@linkplain org.muonmc.gluon.base.api.entrypoint.client.ClientModInitializer ClientModInitializer}, a client-side mod initializer.</li>
 ...
 * <ul>
 *     <li>{@linkplain org.muonmc.gluon.base.api.event.EventAwareListener EventAwareListener}, marks an event callback as usable as an entrypoint.</li>
 *     <li>{@linkplain org.muonmc.gluon.base.api.event.client.ClientEventAwareListener ClientEventAwareListener},
 ...
 *
 * @see org.muonmc.gluon.base.api.entrypoint.ModInitializer
 * @see org.muonmc.gluon.base.api.entrypoint.client.ClientModInitializer
 * @see org.muonmc.gluon.base.api.entrypoint.server.DedicatedServerModInitializer
 */
